...
public class SinterActLoadingScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(getApplicationContext(), SinterAct.class));
                finish();
            }
        },loadingScreenTime);
        ...
        if(!addition || !subtraction || !adddiv || !addmult || !subdiv || !submult || !sqr || !sqrt || !cube || kidsmode) {
            Toasty.error(SinterActLoadingScreen.this,"High Score ranking disabled- check your settings", Toast.LENGTH_LONG,true).show();
        }
    }
    @Override
