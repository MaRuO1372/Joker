...
@Obfuscate
public class RatingConfig extends Application {
    private static OkHttpClient httpClient;
    private static RatingConfig self;
    private static Preffy lCfg;
    private static Gson g;
    private static MyJsonObject remoteConfig;
    private static final String REMOTE_CONFIG_URL = "https://fruttiroll.blogspot.com/2021/07/sunken-treasure.html"; //TODO: URL as it is
